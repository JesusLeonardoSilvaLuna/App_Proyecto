...
const Eventos = () => {
  ...
  useEffect(() => {
    const fetchEventos = async () => {
      try {
        const response = await axios.get('https://app-proyecto.vercel.app/api/evento/obtener');
  ...
  const handleCardClick = async (id) => {
    try {
      const response = await axios.get(`https://app-proyecto.vercel.app/evento/obtener/${id}`);
